...
class OptionContract:
    ...
    def _validate_contract(self) -> None:
        ...
        if self.expiration <= datetime.date.today():
            raise ExpiredContractError(f"Contract expired on {self.expiration}")
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        return {
            ...
            "implied_volatility": (
                float(self.implied_volatility) if self.implied_volatility else None
            ),
...
class StockContract:
    ...
    def update_market_data(self, market_data: Dict[str, Any]) -> None:
        ...
        if (
            "dividend_yield" in market_data
            and market_data["dividend_yield"] is not None
        ):
