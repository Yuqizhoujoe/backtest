    ...
    def connection_string(self) -> str:
        ...
        if self.type == "sqlite":
            ...
            return (
                ...
                f"{self.host}{port_str}/{self.path}"
            )
        else:
...
class ConfigManager:
    ...
    def load_config(self, config_file: Optional[str] = None) -> None:
        ...
        self._loaded = True
        self.logger.info(
            f"Configuration loaded from: {self.config_file or 'defaults + environment'}"
        )
    ...
    def _convert_env_value(self, value: str, section: str, key: str) -> Any:
        ...
        if section == "ibkr" and key in ("port", "client_id"):
            return int(value)
        if section == "portfolio" and key in (
            "initial_cash",
        ...
        config_dict = {
            ...
            "portfolio": {
                ...
                "commission_per_contract": float(
                    self.portfolio.commission_per_contract
                ),
